...
export const ROOMS = [
  ...
  },
  {
    ...
    percent: 25,
    progClass: "urgent",
    footer: "25% collective",
    footerRight: "tonight 23:59",
    footerRightClass: "ddl-u",
    sparkline: true,
    members: [
  ...
  },
  {
    ...
    stageBg: "ri-5",
    stageSize: "sh-md",
    name: "late night finals",
    memberCount: 4,
    title: "final project · landing page",
    tasks: "4 members · 18 / 40",
    deadline: "session 3h 20m",
    deadlineClass: "",
    percent: 45,
    progClass: "",
    footer: "45% collective",
    footerRight: "4d left",
    footerRightClass: "ddl-s",
    members: [
      { key: "laura", w: 72, h: 90 },

...
---
https://github.com/nyu-csci-ua-0467-001-002-spring-26/final-project-liangchuxin/blob/main/client/src/components/MyTasks.jsx#L144-L148
...
MyTasks.jsx - the task list fetch callback uses Array.prototype.sort on a spread copy to order completed tasks last (search for `[...data].sort`), then Array.prototype.map renders each task card.

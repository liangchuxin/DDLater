...
---
https://github.com/nyu-csci-ua-0467-001-002-spring-26/final-project-liangchuxin/blob/main/client/src/components/MyTasks.jsx#L174

Short description for links above
---
Dashboard.jsx L230-L244 - the `filtered` useMemo uses Array.prototype.filter multiple times to narrow the feed by "Due Today" / "0% Done" / "My School" / "My Course" criteria.
...
---
Render free tier cold starts may take 20-40 seconds on the first request after idle. If the deployed site appears unresponsive, please wait a moment and refresh once. The backend (final-project-liangchuxin.onrender.com) and frontend (final-project-liangchuxin-1.onrender.com) are deployed as separate Render services.

Attributions
---
See source code comments. Key references:
